...
-->
    ...
    <button type="button" class="btn btn-outline-dark mb-5 mt-5">Visite nuestro Blog</button>
</div>
<div class="container-fluid">
    ...
    <div class="container mb-5 mt-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <h2 class="font-weight-lighter" style="text-align: left"> <a href="#">El sistema operativo más popular
                        del mundo en nubes públicas y nubes OpenStack ›</a></h2>
                <br><br>
                <h5 class="font-weight-light">
                    <p>Obtenga más información sobre el software de construcción en la nube, las herramientas y los
                        paquetes de servicios de Ubuntu.</p>
                </h5>
            </div>
        </div>
    </div>
    ...
    <div class="container mb-5 mt-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <h2 class="font-weight-lighter" style="text-align: left"> <a href="#">La plataforma número uno para
                        contenedores ›</a></h2>
                <br><br>
                <h5 class="font-weight-light">
        ...
        <div class="row">
            <div class="col border bg-light">
                ...
                <div class="container mb-5 mt-5">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h2 class="font-weight-lighter" style="text-align: left"> <a href="#">Ubuntu, rápido, seguro
                                    y sencillo, impulsa a millones de PC en todo el mundo ›</a></h2>
                            <br><br>
                            <h5 class="font-weight-light">
    ...
    <div class="container mb-5 mt-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 md-1 " style="background-color:#3b69e2; color:#fff">
                ...
                <h5 class="font-weight-light">
                    <br>
                    <p>Una serie de seminarios web bajo demanda para obtener más información sobre Charmed Kubernetes.
                    </p>
                </h5>
            </div>
            <div class="col-lg-3 ml-1" style="background-color:#da2643; color:#fff">
                ...
                <br>
                <h5 class="font-weight-light">
                    <p>Descubra cómo la subcontratación de operaciones de OpenStack puede acelerar el proceso de
                        implementación de la nube privada y ayudar a reducir los costos.</p>
                </h5>
            </div>
